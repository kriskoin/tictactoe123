...
describe ('scenario 1, tictactoe test restart after tie \n', function(){
    ...
    it("create game",async () => {
      ...
      it("get tie",async () => {
        try {
            ...
            assert.equal(errorMessage, "game is over, tie detected");
          }
      });
      ...
      it("restart the game",async () => {
        try {
            ...
            console.log("\n restart the game: caught exception: " + err);
          }
      });
...
/*
scenario 2 restart twice
first after win then after tie
...
describe ('scenario 2, tictactoe test restart (twice) after wnd then after tie \n', function(){
